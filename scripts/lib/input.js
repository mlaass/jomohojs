...
define(['./jo', './Point'], function(jo, Point){
	...
	jo.input = {
		...
		initMouse: function (){	
            ...
            this.sys.screen.canvas.addEventListener('contextmenu', jo.bind(this.contextMenu, this), false);
            this.sys.screen.canvas.addEventListener('mousedown', jo.bind(this.keyDown, this), false);
